...
internal val FolderPlusFill: ImageVector
    get() {
        val current = _folderPlusFill
        if (current != null) return current

        return ImageVector.Builder(
            name = "com.starvault.theme.StarVaultTheme.FolderPlusFill",
            defaultWidth = 256.0.dp,
            defaultHeight = 256.0.dp,
            viewportWidth = 256.0f,
            viewportHeight = 256.0f,
        ).apply {
            // M216 72 H131.31 L104 44.69 A15.88 15.88 0 0 0 92.69 40 H40 A16 16 0 0 0 24 56 V200.62 A15.41 15.41 0 0 0 39.39 216 h177.5 A15.13 15.13 0 0 0 232 200.89 V88 A16 16 0 0 0 216 72Z M40 56 H92.69 l16 16 H40Z m112 96 H136 v16 a8 8 0 0 1 -16 0 V152 H104 a8 8 0 0 1 0 -16 h16 V120 a8 8 0 0 1 16 0 v16 h16 a8 8 0 0 1 0 16Z
            path(
                ...
                close()
                // m 112 96
                moveToRelative(dx = 112.0f, dy = 96.0f)
                // H 136
                horizontalLineTo(x = 136.0f)
                // v 16
