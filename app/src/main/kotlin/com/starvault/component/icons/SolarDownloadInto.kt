...
internal val SolarDownloadInto: ImageVector
    get() {
        val current = _downloadInto
        if (current != null) return current

        return ImageVector.Builder(
            name = "StarVault.SolarDownloadInto",
        ...
        }.build().also { _downloadInto = it }
    }


@Suppress("ObjectPropertyName")
private var _downloadInto: ImageVector? = null
